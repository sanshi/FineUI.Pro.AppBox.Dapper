<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="title_user.aspx.cs" Inherits="FineUI.Pro.AppBox.Dapper.admin.title_user" %>
...
<body class="f-body-darkerbg">
                        ...
                        <f:Grid ID="Grid2" runat="server" BoxFlex="1" ShowBorder="true" ShowBorderShadow="true" ShowHeader="false" EnableCheckBoxSelect="true" 
                            ...
                            <Toolbars>
                                <f:Toolbar ID="Toolbar1" runat="server">
                                    <Items>
                                        <f:Button ID="btnDeleteSelected" Icon="Delete" runat="server" ClickHandler="onDeleteSelectedClick" Text="从当前职称移除选中的用户">
                                        </f:Button>
                                        <f:ToolbarFill runat="server"></f:ToolbarFill>
                                        <f:Button ID="btnNew" runat="server" Icon="Add" OnClick="btnNew_Click" Text="添加用户到当前职称">
                                        </f:Button>
                                    </Items>
                                </f:Toolbar>
                            </Toolbars>
    ...
    <script type="text/javascript">
        ...
        function onDeleteSelectedClick(event) {
            ...
            F.confirm({
                message: F.rawHtml('确定要从当前职称移除选中的&nbsp;<span class="highlight">{0}</span>&nbsp;项记录吗？', selectedRows.length),
                messageIcon: 'warning',
                target: '_top',
                ok: function () {
